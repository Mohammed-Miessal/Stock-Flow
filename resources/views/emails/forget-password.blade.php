                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="email-masthead">
                            ...
                            <span style="font-size: 20px;"> StockFlow</span>
                        </td>
                    </tr>
                    <!-- Email Body -->
                    <tr>
                                    ...
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>You recently requested to reset your password for your
                                                ...
                                                account. <br>
                                                Use the button below to reset it. <br><strong>This password reset
                                                    is only valid for the next 1 minute.</strong>
                                            </p>
                                            <!-- Action -->
                                            ...
                                            {{-- <p>For security, this request was received from a  operating_system 
                                                device using  browser_name . If you did not request a password
                                                reset, please ignore this email or <a href=" support_url ">contact
                                                    support</a> if you have questions.</p> --}}
                                            <p>Thanks,
                                                <br>The <strong>StockFlow</strong> team
                                            </p>
                                            <!-- Sub copy -->
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class="f-fallback sub">If you’re having trouble with the
                                                            ...
                                                            browser.</p>
                                                        <p class="f-fallback sub"> {{ route('reset-password', $token) }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
