                                    ...
                                    <div class="flex w-full">
                                        <div class="grid grid-cols-4 gap-12">
                                            ...
                                            <div class="text-sm font-light text-slate-500">
                                                ...
                                                <p>{{ $invoice->customer->name }}</p>
                                                <p class="text-gray-400 ">{{ $invoice->customer->email }}</p>
                                            </div>
                                            <div class="text-sm font-light text-slate-500">
                                                <p class="text-sm font-bold text-slate-700 dark:text-white ">Invoice Number
                                                </p>
                                                <p> #{{ substr($invoice->invoice_number, 0, 15) }}</p>
                                            </div>
                                            <div class="text-sm font-light text-slate-500">
                                                <p class="text-sm font-bold text-slate-700 dark:text-white ">Start Date</p>
                                                <p>{{ date('d, M, Y', strtotime($invoice->invoice_date)) }}</p>
                                            </div>
                                            <div class="text-sm font-light text-slate-500">
                                                <p class="text-sm font-bold text-slate-700 dark:text-white ">Due Date</p>
