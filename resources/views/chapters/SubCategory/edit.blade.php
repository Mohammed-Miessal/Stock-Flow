                                ...
                                <div
                                    ...
                                    <div class="grid grid-cols-1">
                                        <label class="block mt-4 text-sm">
                                            ...
                                            <input type="text" required name="name" value="{{ $subcategory->name }}"
                                    ...
                                    <div class="grid grid-cols-1">
                                        <label class="block mt-4 text-sm">
                                            ...
                                            <input type="text" required name="description" value="description"
                                                class="block mt-1 mr-4 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                style="width: 80%" />
                                            ...
                                            <select name="category_id" required
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        @if ($category->id == $category->category_id) selected @endif>{{ $category->name }}</option>
                                                @endforeach
