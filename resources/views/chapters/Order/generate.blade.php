...
<head>
    ...
    <!-- Style pour masquer le bouton lors de l'impression -->
    <style>
        @media print {
            #printButton {
                display: none;
                                ...
                                <div class="px-9">
                                    <div class="flex w-full">
                                        <div class="grid grid-cols-4 gap-12">
                                            ...
                                            <div class="text-sm font-light text-slate-500">
                                                <p class="text-sm font-bold text-slate-700 dark:text-white ">Billed To
                                                </p>
                                                <p class="text-gray-400 ">{{ $order->customer->name }}</p>
                                            </div>
                                            <div class="text-sm font-light text-slate-500">
                                                <p class="text-sm font-bold text-slate-700 dark:text-white ">Order
                                                    Number
                                                </p>
                                                <p>{{ $order->uuid }}</p>
...
<article class="overflow-hidden" id="contentToPrint">
